  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center p-4 bg-blue-50 rounded-lg border-blue-600">
        ...
        <div className="text-center p-4 bg-green-50 rounded-lg border-green-600">
        ...
        <div className="text-center p-4 bg-purple-50 rounded-lg border-purple-600">
          <p className="text-sm text-gray-600 mb-1">Current APR</p>
          <p className="text-lg font-bold text-purple-600">{apr.toFixed(2)}%</p>
        </div>
        
        <div className="text-center p-4 bg-orange-50 rounded-lg border-orange-600">
